...
- **Your voice** — a freeform, user-authored description of how you naturally communicate, read before every translation. Nothing about your style is inferred silently. Share it (as plain text) with someone else so their copy of U/I can read your messages more accurately in incoming mode, or tailor what they write to you in outgoing mode (see below).
- **Tailor to a specific recipient** — paste voice notes someone shared with you into outgoing mode too, and opt in with a checkbox to have your message calibrated to them specifically, instead of the generic default rewording.
